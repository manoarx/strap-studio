...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="{{ route('admin.offerbanners.index') }}">Offer Banners</a></li>
...
<section class="section">
  <div class="row">
    <div class="col-lg-6">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Edit Offer Banners</h5>

          <form id="myForm" class="row g-3" action="{{ route('admin.offerbanners.update', [$offerbanner->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <input type="hidden" name="id" value="{{ $offerbanner->id }}">
            <input type="hidden" name="old_image" value="{{ $offerbanner->image }}">
            <div class="col-md-12">
              <label for="inputNanme4" class="form-label">Name</label>
              <input type="text" name="name" class="form-control" value="{{ old('name', isset($offerbanner) ? $offerbanner->name : '') }}" required>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              ...
              <img id="showImage" src="{{ asset($offerbanner->image)   }}" alt="Admin" style="width:100px; height: 100px;"  >
            </div>
