...
<nav>
<ol class="breadcrumb">
  <li class="breadcrumb-item"><a href="">Bulk Products</a></li>
  <li class="breadcrumb-item active">Edit Bulk Products</li>
</ol>
</nav>
</div>
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          ...
          <form class="row g-3" action="{{ route('admin.bulkproducts.update', [$product->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <input type="hidden" name="school_id" value="{{$product->school_id ?? ''}}">
