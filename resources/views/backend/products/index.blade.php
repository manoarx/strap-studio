...
@if(count($products) > 0)
<div class="pagetitle">
<h1>{{ $products[0]->student->student_name ?? '' }} {{ $products[0]->student->student_last_name ?? '' }} - Products</h1>
<nav>
<ol class="breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('admin.students.index',['schoolid' => $products[0]->student->school_id]) }}">Students</a></li>
            ...
            <tbody>
              ...
              <tr data-entry-id="{{ $product->id }}">
                ...
                <td>
                  ...
                  <!-- <a class="btn btn-sm btn-danger" href="{{ route('admin.products.delete',$product->id) }}" id="delete" >Delete</a> -->
