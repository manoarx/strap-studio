		...
		<div class="col-xl-4">
			...
			<div class="card">
				<div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
					...
					<img src="{{ (!empty($adminData->photo)) ? url('upload/admin_images/'.$adminData->photo):url('upload/no_image.jpg') }}" alt="Profile" class="rounded-circle">
					<h2>{{ $adminData->name }}</h2>
					<h3>{{ ucfirst($adminData->type) }}</h3>
							...
							@csrf
								<div class="row mb-3">
									...
									<div class="col-md-8 col-lg-9">
										<img id="showImage" src="{{ (!empty($adminData->photo)) ? url('upload/admin_images/'.$adminData->photo):url('upload/no_image.jpg') }}" alt="Profile">
										<!-- <div class="pt-2">
